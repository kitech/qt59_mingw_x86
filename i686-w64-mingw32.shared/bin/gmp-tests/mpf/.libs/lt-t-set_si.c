...
const char * LIB_PATH_VALUE   = "/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs;/opt/mxe/usr/i686-w64-mingw32.shared/lib;/opt/mxe/usr/i686-w64-mingw32.shared/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/libgmp.l", f);
  fputs ("a ../../libgmp.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("i686-w64-mingw32.shared/lib:/opt/mxe/usr/i686-w64-mingw32.shared/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs:$PATH\"\n", f);
  fputs ("\n", f);
