...
const char * LIB_PATH_VALUE   = "/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs;/opt/mxe/usr/lib/gcc/i686-w64-mingw32.shared/5.4.0;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs;/opt/mxe/usr/lib/gcc/i686-w64-mingw32.shared/5.4.0;/opt/mxe/usr/i686-w64-mingw32.shared/lib;/opt/mxe/usr/i686-w64-mingw32.shared/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' ../../libgmpxx.la /opt/mxe/tmp-gmp-i686-w64-mingw32.shared/", f);
  fputs ("gmp-6.1.2/libgmp.la /opt/mxe/usr/lib/gcc/i686-w64-mingw32.shared/5.4.0/libstdc+", f);
  fputs ("+.la ../../libgmp.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    PATH=/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs:/opt/mxe/usr/", f);
  fputs ("lib/gcc/i686-w64-mingw32.shared/5.4.0:/opt/mxe/usr/i686-w64-mingw32.shared/lib:", f);
  fputs ("/opt/mxe/usr/i686-w64-mingw32.shared/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/opt/mxe/tmp-gmp-i686-w64-mingw32.shared/gmp-6.1.2/.libs:/opt/mxe/usr", f);
  fputs ("/lib/gcc/i686-w64-mingw32.shared/5.4.0:$PATH\"\n", f);
  fputs ("\n", f);
